...
export function FlagGrantModal({
  ...
  const flagsByCategory = filteredFlags.reduce(
    (acc, flag) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.userId || !formData.flagId) {
      return;
    }
  ...
  const isFormValid = formData.userId && formData.flagId;

  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Grant Flag to Member"
      size="large"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-2">
                {expirationTemplates.map((template) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      handleExpirationTemplateChange(template.value)
                    }
              ...
              {(formData.useTemplate === 'custom' ||
                (formData.expiresAt && formData.useTemplate !== '')) && (
                <input
                  type="datetime-local"
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {selectedFlag?.name || 'Not selected'}
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {formData.expiresAt
                      ? format(new Date(formData.expiresAt), 'MMM d, yyyy')
                      : 'Never'}
                  </span>
                </div>
              </div>
            ...
            {/* Permission Preview */}
            {formData.userId && currentPermissions && (
                      ...
                      >
                        ...
                        {flag.expires_at && (
                          <div className="flex items-center gap-1 text-blue-600">
                            ...
                            <span>
                              {format(new Date(flag.expires_at), 'MMM d')}
                            </span>
                          </div>
                        )}
                      </div>
