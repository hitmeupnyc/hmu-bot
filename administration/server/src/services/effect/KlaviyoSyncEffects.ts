...
import { SyncResultSchema, type SyncResult } from "./schemas/CommonSchemas"
import {
  createSyncOperation,
  updateSyncOperation,
  findMemberByEmail,
...
const KlaviyoProfileSchema = Schema.Struct({
  ...
  location: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  properties: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  consents: Schema.optional(Schema.Record(Schema.String, Schema.Unknown))
})
...
const KlaviyoWebhookPayloadSchema = Schema.Struct({
  ...
  event_properties: Schema.optional(Schema.Record(Schema.String, Schema.Unknown)),
  ...
  Effect.gen(function* () {
    ...
    const result = yield* Effect.gen(function* () {
      ...
      switch (validatedPayload.event_type) {
        ...
        default:
          yield* updateSyncOperation(syncOperation.id, 'skipped', `Unknown event type: ${validatedPayload.event_type}`)
      }
